...
{   
   ...
   // TODO : pure motor side low level control (with integral part), for fully exploiting the compliance
   
  //-----------------------------
  yarp::sig::Vector q_motor_0(robot.getNumberOfKinematicJoints() ) ;                  
...
//                            q_motor_init            )  ;
  ...
  size_q = robot.getNumberOfKinematicJoints() ; // TODO : verify
  size_u = 6 ;
  size_fc = 24 ;
  kc = 1E6 ;
...
//    std::cout << " loop_counter = " <<  loop_counter << std::endl; 
  ...
  //-----------------------------------------------------------------------------------------------------------------
  // Updating the q_ ...  // TODO remove unuseful stuff and put this part at the beginning of the loop 
  yarp::sig::Vector q_motor_init( size_q ) ; // robot.getNumberOfKinematicJoints() ) ;                
  ...
  // q_motor_init = locoman::utils::senseMotorPosition( robot, flag_robot ) ;                            
  ...
  //----------------------------------------------------------------------------------------- 
  // Defining the "Auxiliary World" Frame => {AW} // TODO verificare coerenza asse z
...
//   yarp::sig::Matrix J_c_l   = J_c.submatrix( 0, (J_c.rows()/2)-1, 0, J_c.cols() -1) ; // TODO si può rimuovere? verificare...
